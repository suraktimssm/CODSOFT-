...
class SC_Calculator():
    ...
    def Sin(self):
        try:
            self.result = False
            self.current = math.sin(float(ent_field.get()))
            self.Entry(self.current)
        except ValueError:
            self.Entry('Error')
        except SyntaxError:
    ...
    def Cos(self):
        try:
            self.result = False
            self.current = math.cos(float(ent_field.get()))
            self.Entry(self.current)
        except ValueError:
            self.Entry('Error')
        except SyntaxError:
    ...
    def Tan(self):
        try:
            self.result = False
            self.current = math.tan(float(ent_field.get()))
            self.Entry(self.current)
        except ValueError:
            self.Entry('Error')
        except SyntaxError:
...
btn_CE = tk.Button(root, text='CE', command=lambda: sc_app.Clear_Entry(),
                    ...
                    highlightbackground='#ADDBE6', highlightthickness=2)
...
btn_log2 = tk.Button(root, text='log2', command=lambda: sc_app.Log2(),
                    font=FONT, width=5, height=2, fg="#000000",
                    highlightbackground='#ADDBE6', highlightthickness=2)
btn_log2.grid(row=5, column=5, sticky='n'+'s'+'e'+'w', padx=10, pady=10)
    
btn_log10 = tk.Button(root, text='log10', command=lambda: sc_app.Log10(),
                    font=FONT, width=5, height=2, fg="#000000",
                    highlightbackground='#ADDBE6', highlightthickness=2)
